...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    compress : {
      ...
      finalWindowsApp : {
        options : {
          archive : '<%= config.dist %>/swaraServer.zip'
        },
        files   : [
          {
            expand : true,
        ...
        files : [
          {
            ...
            dest : '<%= config.dist %>/swaraServer.app'
          }
        ]
      },
      zipToApp : {
  ...
  grunt.registerTask('chmod', 'Add lost Permissions.', function () {
    var fs = require('fs');
    fs.chmodSync('dist/swaraServer.app/Contents/Frameworks/node-webkit Helper EH.app/Contents/MacOS/node-webkit Helper EH', '555');
    fs.chmodSync('dist/swaraServer.app/Contents/Frameworks/node-webkit Helper NP.app/Contents/MacOS/node-webkit Helper NP', '555');
    fs.chmodSync('dist/swaraServer.app/Contents/Frameworks/node-webkit Helper.app/Contents/MacOS/node-webkit Helper', '555');
    fs.chmodSync('dist/swaraServer.app/Contents/MacOS/node-webkit', '555');
  });
